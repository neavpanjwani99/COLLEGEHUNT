          ...
          <div className="max-w-md">
            <Link href="/" className="flex items-center">
              <Image 
                ...
                height={40} 
                width={160} 
                className="object-contain h-10 w-auto animate-none" 
          ...
          <div className="flex flex-wrap gap-x-16 gap-y-8">
            <div className="min-w-[120px]">
              ...
              <ul className="mt-4 space-y-3 text-[14px] text-[#6B7280]">
                <li>
                  <Link href="/colleges" className="transition-colors hover:text-[#FF385C]">
                    Browse Colleges
                  </Link>
                </li>
                <li>
                  <Link href="/compare" className="transition-colors hover:text-[#FF385C]">
                    Smart Compare
                  </Link>
                </li>
                <li>
                  <Link href="/shortlist" className="transition-colors hover:text-[#FF385C]">
                    My Shortlist
                  </Link>
                </li>
              </ul>
            ...
            <div className="min-w-[120px]">
              ...
              <ul className="mt-4 space-y-3 text-[14px] text-[#6B7280]">
                <li className="cursor-pointer transition-colors hover:text-[#FF385C]">Privacy Policy</li>
                <li className="cursor-pointer transition-colors hover:text-[#FF385C]">Terms of Service</li>
                <li className="cursor-pointer transition-colors hover:text-[#FF385C]">Data Sources</li>
              </ul>
            </div>
          </div>
        </div>
